...
class MainModulo { 
    ...
    public static void main(String[] args) { 
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    // Creamos un objeto de la clase Modulo
                    Modulo a = new Modulo(); 
                    ...
                    System.out.println("El resultado del modulo es: " + (a.getNum() % a.getNum2())); //en un sout hacemos la modulacion de los numeros
